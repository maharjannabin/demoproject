...
class ProductSizeController extends Controller {
    ...
    public function index() {
        $sizes = ProductSize::findSize();

        return view('product-size.index', ['sizes' => $sizes]);
    }
    ...
    public function edit(Request $request, $id) {
        ...
        return view('product-size.update', ['size' => $size]);
    }
    ...
    public function destroy($id) {
        $model = ProductSize::find($id) -> update(['is_disabled' => ProductSize::INACTIVE]);
